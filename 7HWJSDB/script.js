...
const customItem = document.querySelectorAll('li');
...
const getTegColCont = (nametag, namecol, cont) => {
    const elen = document.createElement(nametag);
    elen.style.color = namecol;
    elen.textContent = cont;
    document.body.append(elen);

}
getTegColCont('p', 'red', 'text')
